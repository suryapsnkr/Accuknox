...
from snaccu.serializers import UserSerializer, CreateUserSerializer, LoginUserSerializer, QuerySerializer, FRSerializer, FASerializer
...
class LoginUser(APIView):
    ...
    def post(self, request):
            ...
            if user is not None:
                ...
                return Response({'Message': "Login Success", "UserInfo": {"fname": user.first_name, "lname": user.last_name, "emai":user.email, "token":token.key}})
            else:
